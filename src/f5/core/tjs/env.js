...
// Deprecated: Not used in non-Node environments
...
const IS_PROCESS_AVAILABLE = false; // Deprecated: typeof process !== "undefined";
const IS_NODE_ENV = false; // Deprecated: IS_PROCESS_AVAILABLE && process?.release?.name === "node";
const IS_FS_AVAILABLE = false; // Deprecated: !isEmpty(fs);
const IS_PATH_AVAILABLE = false; // Deprecated: !isEmpty(path);
